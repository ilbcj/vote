	...
	public int ProcessEvent(int iCh, int lType, int lHandle, int lResult,
		...
		try {
			...
			case BriSDKLib.BriEvent_GetDTMFChar:
				...
				if(strValue.equals("Handle=0Result=0Data=1")) {
					String pfile = "E:\\work\\vote\\doc\\old_20160901\\bak\\Voice\\rec\\ok.wav";
					int ret = BriSDKLib.QNV_PlayFile(iCh, BriSDKLib.QNV_PLAY_FILE_START, 0, 0, pfile);
					System.out.println(ret);
				}
				else if(strValue.equals("Handle=0Result=0Data=0")) {
					String pfile = "E:\\work\\vote\\doc\\old_20160901\\bak\\Voice\\rec\\cancel.wav";
					int ret = BriSDKLib.QNV_PlayFile(iCh, BriSDKLib.QNV_PLAY_FILE_START, 0, 0, pfile);
					System.out.println(ret);
				}
				else {
					BriSDKLib.QNV_SetDevCtrl(iCh, BriSDKLib.QNV_CTRL_DOHOOK, 0);
					BriSDKLib.QNV_SetParam(iCh, BriSDKLib.QNV_PARAM_HANGUPELAPSE, 500);
				}
				break;
			case BriSDKLib.BriEvent_RemoteHook: {
				if (BriSDKLib.HOOK_POLARITY == lResult) {
					...
					//test
					String pfile = "E:\\work\\vote\\doc\\old_20160901\\bak\\Voice\\rec\\begin.wav";
					int ret = BriSDKLib.QNV_PlayFile(iCh, BriSDKLib.QNV_PLAY_FILE_START, 0, 0, pfile);
					System.out.println(ret);
					//test
				} else
